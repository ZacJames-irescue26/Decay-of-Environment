...
{
	static ConstructorHelpers::FClassFinder<UUserWidget> ServerRowBPClass(TEXT("/Game/TopDown/Blueprints/MenuSystem/BP_ServerRow"));
...
void UMainMenu::JoinServer()
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("Selected index not found"));
	}
