...
public:
	...
	static bool IsDestination(int x, int y, ACubeTile* TileDest);
	static float CalculatehCost(int x, int y, ACubeTile* TileDest);
	static TArray<ACubeTile*> A_star(ACubeTile* start, ACubeTile* end, int32 MapXSize, int32 MapYSize, TArray<TArray<ACubeTile*>> OpenSet);
};
